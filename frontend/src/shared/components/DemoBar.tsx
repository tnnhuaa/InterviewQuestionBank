...
const QUICK_LINKS: { label: string; path: string; role: Role }[] = [
  ...
  { label: 'Event Loop', path: '/questions/javascript-event-loop', role: 'public' },
  { label: 'Mentors', path: '/mentors', role: 'public' },
  { label: 'Mentor Profile', path: '/mentors/00000000-0000-0000-0000-000000000401', role: 'public' },
  { label: 'Dashboard', path: '/student/dashboard', role: 'student' },
  { label: 'S11 JD Upload', path: routes.jobDescriptionNew, role: 'student' },
  { label: 'S12 OCR Review', path: routes.jobDescriptionReview('00000000-0000-0000-0000-000000000901'), role: 'student' },
  { label: 'S13 Mapping', path: routes.jobDescriptionMapping('00000000-0000-0000-0000-000000000901'), role: 'student' },
  { label: 'S14 Questions', path: routes.preparationPlan('00000000-0000-0000-0000-000000000931'), role: 'student' },
  { label: 'Booking Form', path: '/bookings/new', role: 'student' },
  { label: 'Booking Status', path: routes.booking('00000000-0000-0000-0000-000000000962'), role: 'student' },
  { label: 'Session', path: '/sessions/00000000-0000-0000-0000-000000000962', role: 'student' },
  { label: 'Feedback', path: routes.feedback('00000000-0000-0000-0000-000000000966'), role: 'student' },
  { label: 'Review', path: routes.review('00000000-0000-0000-0000-000000000966'), role: 'student' },
  ...
  { label: 'Booking Decision', path: '/mentor/bookings/00000000-0000-0000-0000-000000000961', role: 'mentor' },
  { label: 'Mentor Session', path: '/mentor/sessions/00000000-0000-0000-0000-000000000962', role: 'mentor' },
  { label: 'Give Feedback', path: '/mentor/feedback/00000000-0000-0000-0000-000000000966', role: 'mentor' },
  { label: 'Admin Queue', path: '/admin', role: 'admin' },
  { label: 'Mentor Review', path: '/admin/mentors/00000000-0000-0000-0000-000000000498/review', role: 'admin' },
  { label: 'Question Mgmt', path: '/admin/questions', role: 'admin' },
  { label: 'Case Detail', path: '/admin/cases/00000000-0000-0000-0000-000000000951', role: 'admin' },
  { label: 'Audit Log', path: '/admin/audit/all', role: 'admin' },
]
