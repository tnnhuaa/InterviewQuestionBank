...
![Live PrepVI frontend](../../print/Q15_devops/img/Q15-01-live-frontend.png)

**Hình Q15-02 - Cửa sổ GitHub Actions thật của repository.**

![GitHub Actions workflow runs](../../print/Q15_devops/img/Q15-02-github-actions.png)

**Hình Q15-03 - Cấu hình Terraform được mở trực tiếp trên GitHub.**

![Terraform configuration on GitHub](../../print/Q15_devops/img/Q15-03-terraform-github.png)
...
![Public API health response in Windows Terminal](../../print/Q15_devops/img/Q15-04-api-health-terminal.png)
...
- **Bản in tiếng Anh:** [DevOps Implementation and Infrastructure Report](../../print/Q15_devops/DevOps_Report.md). Report đã nhúng mô hình, kịch bản Terraform an toàn, cây thư mục IaC, bốn ảnh minh chứng thật và ghi rõ bằng chứng còn thiếu.
- **Tài liệu nguồn, không phải bản in thay thế:** [IaC operations guide](../../../../iaac_tutorial.md), [redacted Terraform plan](../../../DevOps/03-plan.txt), [GitHub Actions CI](../../../../.github/workflows/ci.yml) và [Terraform main configuration](../../../../infra/main.tf).
