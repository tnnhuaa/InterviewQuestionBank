...
const pages = {
  ...
  studentProfile: lazyPage(() => import("@/features/student/pages/StudentProfile")),
  studentPreparationContexts: lazyPage(() => import("@/features/student/pages/PreparationContexts")),
  ...
  adminQuestionImport: lazyPage(() => import("@/features/admin/pages/AdminQuestionImport")),
  adminTaxonomy: lazyPage(() => import("@/features/admin/pages/AdminTaxonomy")),
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: routes.studentProfile, lazy: pages.studentProfile },
      { path: routes.studentPreparationContexts, lazy: pages.studentPreparationContexts },
      ...
      { path: routes.adminQuestionImport, lazy: pages.adminQuestionImport },
      { path: routes.adminTaxonomy, lazy: pages.adminTaxonomy },
