...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/job-description/ocr-review", element: <Navigate to={routes.jobDescriptionReview("demo-jd")} replace /> },
      { path: "/job-description/mapping", element: <Navigate to={routes.jobDescriptionMapping("demo-jd")} replace /> },
      { path: "/job-description/recommendations", element: <Navigate to={routes.preparationPlan("demo-plan")} replace /> },
