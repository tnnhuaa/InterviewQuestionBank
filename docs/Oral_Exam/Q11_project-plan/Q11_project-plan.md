...
6. **Baseline định lượng:** 6 thành viên, 768 giờ danh nghĩa, reserve 15%, khoảng 653 giờ cho scope, bốn sprint hai tuần và cash ceiling 1.125.000 VNĐ; actual cash cost là 0 VNĐ vì nhóm chỉ dùng free tier.
...
Nhóm tạo bản đầu sau khi đã làm rõ mục tiêu, phạm vi và các deliverable chính. Với dự án thích ứng, nhóm không “đóng băng” toàn bộ kế hoạch; nhóm giữ mục tiêu, ràng buộc và mốc kiểm soát ở cấp cao, rồi cập nhật backlog, estimate và release forecast sau mỗi sprint hoặc sau một thay đổi lớn.
...
- **Gia Thành — PM/Scrum Master:** sở hữu baseline, ước lượng, nguồn lực, tiến độ và rủi ro.
- **Hưng — Product Owner/BA:** sở hữu tầm nhìn, phạm vi, backlog và acceptance.
- **Tuấn Anh — Trưởng nhóm:** điều phối dependency, review phạm vi, escalation, tích hợp và delivery readiness.
- **Hùng, Trí, Luân:** cung cấp lần lượt bằng chứng UI/UX, PoC/E2E và kiến trúc.
...
| Đo được        | Có KPI, milestone và Go/No-Go gate                                                                        | Chưa có actual effort, velocity hoặc burndown trong repo                      |
...
- **HOW:** Nhóm lập kế hoạch chi tiết cho sprint gần nhất, giữ kế hoạch thô cho phần xa hơn, rồi dùng velocity, feedback và backlog refinement để reforecast.
- **WHY:** Thay đổi yêu cầu không loại bỏ nhu cầu quản lý thời gian, chi phí, rủi ro và kỳ vọng của stakeholder.
- **WHEN:** Cập nhật sau mỗi sprint, sau demo/UAT hoặc khi scope, capacity, risk hay dependency thay đổi đáng kể.
