...
![Phạm vi MVP candidate-first](../../print/Q11_project-plan/img/Q11-01-mvp-scope-candidate-first.png)

**Ảnh 2 — Nhóm xác nhận chính thức ý tưởng web interview ngày 13/08/2026:**

![Nhóm xác nhận ý tưởng web interview](../../print/Q11_project-plan/img/Q11-02-team-confirms-interview-idea.png)

**Ảnh 3 — Thành viên tóm tắt đề xuất của giảng viên thực hành ngày 14/08/2026:**

![Tóm tắt góp ý về pain point ứng viên](../../print/Q11_project-plan/img/Q11-03-instructor-feedback-summary.png)

**Ảnh 4 — Nhóm thông báo cập nhật theo hướng đã chốt và chuẩn bị PR để review:**

![Thông báo cập nhật phạm vi và kế hoạch](../../print/Q11_project-plan/img/Q11-04-team-updates-scope-and-plan.png)

**Ảnh 5 — PoC ứng viên gồm nhập JD, trích xuất, sửa văn bản, chuẩn hóa kỹ năng và ánh xạ câu hỏi; luồng Mentor cũ được giữ riêng:**

![PoC ứng viên và quyết định giữ luồng Mentor](../../print/Q11_project-plan/img/Q11-05-candidate-poc-and-mentor-split.png)

**Ảnh 6 — Reconstructed Kanban tổ chức công việc theo User Story trong bốn tuần:**

![Reconstructed Kanban theo User Story](../../print/Q11_project-plan/img/Q11-06-reconstructed-kanban-user-stories.png)
