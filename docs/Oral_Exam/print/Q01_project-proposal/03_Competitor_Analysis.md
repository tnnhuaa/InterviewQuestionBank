...
![LeetCode — Top Interview 150 study plan](img/leetcode-workflow-01-study-plan.png)

**Step 2 — Select a question by topic group and difficulty**

![LeetCode — Select a question from the Array/String group](img/leetcode-workflow-02-topic-tags.png)

**Step 3 — Open the problem, code editor, and test cases**

![LeetCode — Problem description and code editor](img/leetcode-workflow-03-problem-editor.png)

### 7.2 interviewing.io

**Step 1 — Open interviewing.io and review the available practice paths**

![interviewing.io — Home page and AI Interviewer entry point](img/interviewingio-workflow-01-home.png)

**Step 2 — Open AI Interviewer and reach the login requirement**

![interviewing.io — Login required for AI Interviewer](img/interviewingio-workflow-02-ai-interviewer.png)

**Step 3 — Filter public interview replays by System Design**

![interviewing.io — System Design replay library](img/interviewingio-workflow-03-replay-library.png)

**Step 4 — Open the Coding Practice Platform replay**

![interviewing.io — Coding Practice Platform replay](img/interviewingio-workflow-04-replay-detail.png)

**Step 5 — Review the structured interview feedback**

![interviewing.io — Structured interview feedback](img/interviewingio-workflow-05-feedback.png)
