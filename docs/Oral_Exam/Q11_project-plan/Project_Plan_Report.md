...
| Chủ sở hữu kế hoạch        | Gia Thành — Project Manager/Scrum Master                                   |
| Quản trị và điều phối nhóm | Tuấn Anh — Trưởng nhóm                                                     |
...
Ngày 16/08, Tuấn Anh tái dựng Kanban từ Product Backlog. Backlog cung cấp mã US, priority, release, dependency, SP, acceptance criteria, Definition of Ready/Done và kế hoạch bốn sprint. Assignee, tuần thực hiện và ngày `Ready/Done` trên board là dữ liệu tái dựng, không có sẵn trong backlog.
...
| Nhịp review kế hoạch        | Sprint 2 tuần; reforecast cuối mỗi sprint |

### 6.2 Ownership

| Thành viên/vai trò                 | Ownership chính                                                                | Trách nhiệm phối hợp                                                  |
| ---------------------------------- | ------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| Gia Thành — PM/Scrum Master        | Initiation, estimation, plan, risk, cost/time/resource và release coordination | Review requirement, UAT và tài liệu.                                  |
| Hưng — Product Owner/BA            | Vision, scope, backlog, acceptance criteria và business rule                   | Discovery, ưu tiên giá trị và UAT acceptance.                         |
| Tuấn Anh — Trưởng nhóm             | Leadership, governance, integration và delivery readiness                      | Scope review, stakeholder alignment, escalation và review chất lượng. |
| Hùng — UI/UX                       | Research, workflow, clickable prototype và usability evidence                  | UI acceptance và accessibility.                                       |
| Trí — PoC/E2E                      | PoC, seed data, integration test và technical-risk evidence                    | Core flow implementation.                                             |
...
Các vai trò front-end, back-end, QA, DevOps và content được giao theo work package; nhóm không giả định mỗi chức danh chỉ thuộc một người. Story chỉ vào sprint khi đạt Definition of Ready và được người thực hiện tham gia estimate.
...
1. Product Owner quản lý backlog và acceptance criteria; PM/Scrum Master giữ cost, time, resource, risk và release forecast.
...
3. Sprint có nhịp hai tuần. Cuối sprint, nhóm review carry-over, blocker, chất lượng và forecast-to-complete.
...
| Thiếu dữ liệu theo dõi       | Không có timesheet, velocity hoặc trạng thái gốc            | Gắn nhãn reconstructed, không suy diễn thành actual.                       |
...
- carry-over hoặc velocity thấp kéo dài hai sprint;
...
Giới hạn lớn nhất là dữ liệu actual về tiến độ và effort. Nhóm chỉ execution InterviewQuestionBank trong hai tuần, trong khi kế hoạch phải mô tả cửa sổ tám tuần. Việc tái dựng bốn tuần giúp giải thích cách phân bổ backlog nhưng không thay thế timesheet, velocity, burndown hoặc board được cập nhật tại thời điểm thực hiện. Estimate 606/650 giờ cũng đã lệch phiên bản backlog. Riêng actual cash đã được nhóm xác nhận là 0 VNĐ do chỉ dùng free tier.
...
| ---------------------------- | ------------------ | ------------------------------------------------ | ------------------------- |
| Project Manager/Scrum Master | Gia Thành          | Cost, time, resource, risk và release forecast   | Chờ xác nhận              |
| Product Owner/BA             | Hưng               | Mục tiêu, phạm vi, backlog và acceptance         | Chờ xác nhận              |
| Trưởng nhóm                  | Tuấn Anh           | Governance, dependency, integration và readiness | Đã review ngày 23/08/2026 |
